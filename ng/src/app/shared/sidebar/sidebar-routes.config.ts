...
export const ROUTES: RouteInfo[] = [
        ...
        submenu: [
            ...
            },
            {
                ...
                submenu: [
                    ...
                    { path: '/UserProfile', title: 'User Profile', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
                    { path: '/Donar', title: 'Donar', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    },
    {
        ...
        submenu: [
            ...
            { path: '/DataGrid', title: 'DataGrid', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
