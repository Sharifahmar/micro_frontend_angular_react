...
@Directive({
  ...
  providers: [{ provide: NG_ASYNC_VALIDATORS, useExisting: checkPhoneNumberValidatorDirectiveDonar, multi: true }]
})
export class checkPhoneNumberValidatorDirectiveDonar implements AsyncValidator {
