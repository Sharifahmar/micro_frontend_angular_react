...
// Custom Success Type Alert
export function customtypeSuccess(title: string, message?: string) {
    swal(title, message, "success");
}

// Custom Error Type Alert
export function custometypeError(title: string, message?: string) {
...
// Custom Confirm Button Action
export function customConfirmText() {
    swal({
        title: 'Are you sure?',
